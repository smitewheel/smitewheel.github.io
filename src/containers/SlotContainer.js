...
import gods from '../helpers/gods.json'
...
const SlotContainer = () => {
  const [godsList, setGodsList] = useState(gods)
  ...
  const handleSetFilter = (newFilter) => {
    setWinners({})
    if (newFilter === 'Custom') {
      setFilteredList(godsList.filter((god) => tiggzMode.includes(god.name)))
      setFilter(newFilter)
    } else if (newFilter === 'Reset') {
      setFilteredList(godsList)
      setFilter(null)
    } else {
      setFilteredList(godsList.filter((god) => god.role === newFilter))
      setFilter(newFilter)
    }
  }
  ...
  const triggerSlotRotation = (ref) => {
    ...
    let randomOption = Math.floor(Math.random() * optionList.length)
    ...
    <>
      ...
      <div className='SlotMachine'>
        ...
        <span>
          ...
          <button
            id={slots === 1 ? 'activeButton' : ''}
            className='teamButtons'
            onClick={(e) => handleSlotsChange(e, 1)}
          >
            Just me
          </button>
          <button
            id={slots === 2 ? 'activeButton' : ''}
            className='teamButtons'
            onClick={(e) => handleSlotsChange(e, 2)}
          >
            2v2
          </button>
          <button
            id={slots === 3 ? 'activeButton' : ''}
            className='teamButtons'
            onClick={(e) => handleSlotsChange(e, 3)}
          >
            3v3
          </button>
          <button
            id={slots === 4 ? 'activeButton' : ''}
            className='teamButtons'
            onClick={(e) => handleSlotsChange(e, 4)}
          >
            4v4
          </button>
          <button
            id={slots === 5 ? 'activeButton' : ''}
            className='teamButtons'
            onClick={(e) => handleSlotsChange(e, 5)}
          >
            5v5
          </button>
        </span>
